...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.NumberViewHolder> {
    ...
    public CustomAdapter(int numListItems, ListItemClickListener listener, List<Message> messages) {
    ...
    public int getIcon(String icon_name) {
        switch (icon_name) {
            case "TYPE_ROBOT":
    ...
    public NumberViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        TextView tv_description = viewHolder.itemView.findViewById(R.id.tv_description);
        TextView tv_time = viewHolder.itemView.findViewById(R.id.tv_time);
        CircleImageView circleImageView = viewHolder.itemView.findViewById(R.id.iv_avatar);
        ImageView robot_notice = viewHolder.itemView.findViewById(R.id.robot_notice);
        tv_description.setText(mmessages.get(viewHolderCount).getDescription());
        tv_time.setText(mmessages.get(viewHolderCount).getTime());
        tv_title.setText(mmessages.get(viewHolderCount).getTitle());
        robot_notice.setVisibility(mmessages.get(viewHolderCount).isOfficial() ? View.VISIBLE : View.INVISIBLE);
        circleImageView.setImageResource(getIcon(mmessages.get(viewHolderCount).getIcon()));
